...
public class UtilClassDispatcher {
    ...
    static utils.Constant constant=new utils.Constant();
    ...
    public static void initInprogress(int id) throws SQLException {
        ...
        status="InProgress";
        UtilClassDispatcher.updateDatabase(strColumnName, status,id, constant.SQL_JDBC_URL, constant.SQL_USER_NAME,
                utils.Constant.DB_KEY);
    ...
    public static void updateDatabase(String column, String value, int id, String jdbcUrl, String userName, String password) {
        String updateQuery =
                "UPDATE "+ utils.Constant.TABLE_NAME_DEEPNET_WORKITEM +" Set "+column+" = '"+value+"' WHERE id='" + id + "'";
    ...
    public static void sendEmail(String type,String failureMsg,String processName) throws Exception {
        ...
        email.setfrom(utils.Constant.MAIL_FROM);
        email.setTo(utils.Constant.TO);
    ...
    public static void setDriver(WebDriver driver) {
        UtilClassDispatcher.driver = driver;
    }
